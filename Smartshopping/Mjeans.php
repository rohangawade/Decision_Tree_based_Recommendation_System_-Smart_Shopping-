...
$sql = "SELECT COUNT(*) FROM items where category='Jeans' AND gender='M' ";
$result = select($sql);
...
$sql = "SELECT itemid, name, category, brand, color, price, path FROM items WHERE category='Jeans' AND gender='M' LIMIT $offset, $rowsperpage";
$result = select($sql);
$i=1;
