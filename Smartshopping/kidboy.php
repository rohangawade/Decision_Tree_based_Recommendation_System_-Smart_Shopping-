...
$sql = "SELECT COUNT(*) FROM items where gender='M' AND category='Kids'";
$result = select($sql);
...
$sql = "SELECT itemid, name, category, brand, color, price, path FROM items WHERE gender='M' AND category='Kids' LIMIT $offset, $rowsperpage";
$result = select($sql);
$i=1;
